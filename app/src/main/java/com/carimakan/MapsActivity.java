...
import com.carimakan.util.DirectionsJSONParser;
...
public class MapsActivity extends FragmentActivity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d(TAG, "lat: " + lat);
        Log.d(TAG, "lng: " + lng);
        //Log.d(TAG, "int: " + dataModel.getUrlpic());
        ...
        Log.d(TAG, " current lat: " + lati);
        Log.d(TAG, " current lng: " + longti);

        latAwal = Double.parseDouble(lati);
        lngAwal = Double.parseDouble(longti);
        latTujuan = Double.parseDouble(lat);
        lngTujuan = Double.parseDouble(lng);

        // Initializing
        markerPoints = new ArrayList<LatLng>();

        LatLng point = new LatLng(latAwal,lngAwal);
        LatLng point2 = new LatLng(latTujuan,lngTujuan);
...
class MyLocationListners implements LocationListener {
